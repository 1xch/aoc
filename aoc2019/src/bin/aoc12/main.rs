...
struct Moon
{
    pub x: vector::Vec3<i32>,
    pub v: vector::Vec3<i32>,
}
...
impl Moon
{
    pub fn new() -> Self
    {
        Self
        {
            x: vector::Vec3::new(0, 0, 0),
            v: vector::Vec3::new(0, 0, 0),
        }
    }
...
fn main() {
    println!("part1 {}", part1("<x=-7, y=-1, z=6>
<x=6, y=-9, z=-9>
<x=-12, y=2, z=-7>
<x=4, y=-17, z=-12>"));
    println!("part2 {}", part2("<x=-7, y=-1, z=6>
<x=6, y=-9, z=-9>
<x=-12, y=2, z=-7>
<x=4, y=-17, z=-12>"));
}
