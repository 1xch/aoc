...
use aoc2019::input::parse_list;
use aoc2019::intcode::{Machine, ProgramMachine, StepResult};
use aoc2019::vector2d::Vector2D;

fn main() {
    let program: Vec<i64> = parse_list(include_str!("input.txt"), ',');
...
fn part2(program: &Vec<i64>) -> i64 {
    ...
    let a = "L,12,L,6,L,8,R,6";
    let b = "L,8,L,8,R,4,R,6,R,6";
    let c = "L,12,R,6,L,8";
